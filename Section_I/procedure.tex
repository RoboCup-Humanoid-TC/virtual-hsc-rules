...
\item \added{
    At the beginning of every kick, the kicker and the goalkeeper are spawned at
...
\item \removed{Only the eligible players and match officials are permitted to
...
\item ... touched the ball \removed{more often} \added{in a larger number of the performed trials}. If this is a tie:
...
\end{enumerate}
\item If this is a tie a coin is flipped \added{by the Technical Committee}
\end{itemize}
