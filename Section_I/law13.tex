...
\begin{itemize}
\item the kick is retaken \simplify{(new:) }\added{once} if the goal keeper managed to reach the ball within the time frame. Otherwise, the ball is in play again.
\end{itemize}
