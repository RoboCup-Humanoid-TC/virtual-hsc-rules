...
The referee \removed{blows the whistle,} announces 'Free-Kick' blue or red\added{ and communicates ``Direct / Indirect Free Kick'' Blue/Red to the GameController.} \removed{and then places
the ball depending on the call.}
\removed{The assistant referee who operates the game controller clicks on
``Direct / Indirect Free Kick'' Blue/Red.}
\removed{During this phase robots may move their head to track the ball but must
...
the free kick.
\added{Any player from } the team taking the free kick may announce that the player is ready to take the
...
\begin{itemize}
\item the kick is retaken (new:) \added{once} if the goal keeper managed to reach the ball within the time frame. Otherwise, the ball is in play again.
\end{itemize}
