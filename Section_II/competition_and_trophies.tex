...
robot\added{s} \removed{an hour in advance of a game }\added{before the start of
  the tournament}. Any concern regarding the rule compliance of any of the
robots, including the amount, size and colour of the team markers, must be
brought to the attention of the \removed{referee an hour in advance of the game}
\added{Technical Committee a week before the start of the tournament}.
