...
\item \removed{The referee places the ball depending on the call and announces "Free Kick Ready".
      ...
      \added{%
        ...
        \begin{enumerate}
        \item Apply a removal penalty to all fallen and already penalized robots
          that are located at a distance lower than $D$ of the ball.
        \item If previous step was not sufficient to ensure distance $D$, the
        ...
        \item If both previous steps were not successful, the remaining robots
